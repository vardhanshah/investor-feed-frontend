    ...
    <div className="min-h-screen bg-background text-white py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8 border-l-4 border-l-yellow-500">
            <h2 className="text-2xl font-alata text-white mb-4">3. Important Disclaimers</h2>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">4. User Eligibility</h2>
            <p className="text-gray-300 font-alata mb-4">To use our services, you must:</p>
            <ul className="text-gray-300 font-alata mb-4 list-disc pl-6">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">5. Account Terms</h2>
            <p className="text-gray-300 font-alata mb-4">If you create an account, you agree to:</p>
            <ul className="text-gray-300 font-alata mb-4 list-disc pl-6">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">6. Prohibited Activities</h2>
            <p className="text-gray-300 font-alata mb-4">You agree NOT to:</p>
            <ul className="text-gray-300 font-alata mb-4 list-disc pl-6">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">7. Intellectual Property</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">8. Limitation of Liability</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">9. Indemnification</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">10. Termination</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">11. Modifications</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">12. Governing Law & Dispute Resolution</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">13. Severability</h2>
            <p className="text-gray-300 font-alata mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 shadow-lg border border-gray-700 mb-8">
            <h2 className="text-2xl font-alata text-white mb-4">14. Contact Information</h2>
            <p className="text-gray-300 font-alata mb-4">
